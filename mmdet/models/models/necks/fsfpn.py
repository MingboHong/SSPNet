...
from ..module.CBAM.CBAM import Spatial_Attention
import torch


@NECKS.register_module()
class FSFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.ASPP = Spatial_Attention(out_channels)
        # self.grads = {}
        if end_level == -1:
    ...
    def forward(self, inputs):
        ...
        att_list = self.ASPP(laterals)
        laterals = [(1 + att_list[i]) * laterals[i] for i in range(len(laterals))]  # (1+att_list[i])*
